...
Future<void> main() async {
  ...
  final notificationLaunch =
      await NotificationService.instance.getLaunchAlarmIdFromNotification();
  final ringingId = await AlarmStorage.instance.getRingingAlarmId();
  final pendingId = AlarmTriggerBridge.consumePending();

  runApp(OuttaBedApp(
    initialAlarmId: nativeLaunch ?? notificationLaunch ?? pendingId ?? ringingId,
  ));
}
