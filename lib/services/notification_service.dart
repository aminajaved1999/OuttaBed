...
class NotificationService {
  ...
  Future<String?> getLaunchAlarmIdFromNotification() async {
    await init();
  ...
  Future<void> schedulePlatformBackup(Alarm alarm, DateTime scheduledAt) async {
  ...
  Future<void> cancelPlatformBackup(String alarmId) async {
    await _plugin.cancel(alarmNotificationId(alarmId));
  }
}
